import { e as createComponent, g as addAttribute, o as renderHead, k as renderSlot, r as renderTemplate, h as createAstro, m as maybeRenderHead } from './astro/server_uYHly2D0.mjs';
import 'piccolore';
import 'clsx';
/* empty css                         */
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es" class="h-full antialiased"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description"${addAttribute(description, "content")}><title>${title}</title>${renderHead()}</head> <body class="min-h-full flex flex-col bg-csp-background text-csp-black"> ${renderSlot($$result, $$slots["default"])} </body></html>`;
...
export { $$PublicHeader as $, CATEGORY_OPTIONS as C, DISCOVERY_SOURCE_OPTIONS as D, EVENT_NAME as E, SCHOOL_RESPONSIBLE_ROLES as S, $$PublicFooter as a, $$BaseLayout as b };
